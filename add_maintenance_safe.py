...
# Находим строку "export default function Home() {"
pattern = r'(export default function Home\(\) \{\n)'

maintenance_code = """  const maintenanceUntil = new Date('2026-09-20T23:59:59');
...
# Вставляем код сразу после "export default function Home() {"
new_content = re.sub(pattern, r'\1' + maintenance_code, content, count=1)

with open('app/page.tsx', 'w', encoding='utf-8') as f:
    f.write(new_content)

print("✅ Заглушка успешно добавлена!")
