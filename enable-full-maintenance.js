...
content = content.replace(/const maintenanceUntil[\s\S]*?if \(isMaintenance\) \{[\s\S]*?\}\n\s*\}/, '');
...
content = content.replace(
  ...
  `export default function Home() {${fullMaintenance}`
);

fs.writeFileSync('app/page.tsx', content);
console.log('✅ Полная заглушка добавлена!');
