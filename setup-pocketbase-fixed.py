...
print("🔧 Исправленная настройка PocketBase...")
print()
...
# 2. Создание коллекций (исправлено: 'fields' заменено на 'schema')
collections = [
    {
        "name": "products",
        "type": "base",
...
for col in collections:
    ...
    if resp.status_code == 200:
        print(f"  ✅ {col['name']} создана успешно!")
    else:
        print(f"\n❌ Ошибка при создании '{col['name']}':")
        print(f"   Статус: {resp.status_code}")
        print(f"   Ответ: {resp.text}")

print("\n🎉 Готово! Обнови страницу http://127.0.0.1:8090/_/#/collections")
